...
.controller('EntriesCtrl', function ($scope, $rootScope, $uibModal, $state, EntryService, SessionService, LocationService, TagService, TagClassService, ngTableParams, CONST) {
  ...
  $scope.tagsSelectorPulldown = TagService.getByClass(['sector', 'vulnerable', 'affected', 'underlying', 'crisis_driver']);
...
.controller('EntryCtrl', function ($scope, $rootScope, $state, $stateParams, $sce, uiGmapIsReady, CONST, entry, Entry, EntryService, APIService, TagService, TagClassService, LocationService, LocationOverlay, DomainService, LeadService, SessionService, tagclassStates) {
  ...
  // load tag group data
  angular.forEach(['sector', 'vulnerable', 'affected', 'underlying', 'crisis_driver'], function(tag_class){
